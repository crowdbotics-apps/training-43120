"""
Django settings for training_43120 project.
...
ROOT_URLCONF = 'training_43120.urls'
...
WSGI_APPLICATION = 'training_43120.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "training_43120 API",
    "DESCRIPTION": "API documentation for training_43120 App",
    "VERSION": "v1",
}
